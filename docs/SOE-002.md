---
id: SOE-002
title: Capture Sales Quote
sidebar_label: Capture Sales Quote
slug: /502
---
...
24. Click the **[+ Add]** (_Items_) button to open the company's product catalogue.  
...
:::important
If you are unable to find the product you are looking for, or if the customer wants you to initiate a change to an existing product, use the procedure titled **[SOE-003](SOE-003.md)** to capture this information as a new item request. You can then continue with step _**24**_.
:::
