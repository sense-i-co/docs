...
3.  Click AP (for Accounts Payable) Open Installment on the side menu.  

![](../static/img/docs/SAF-4050/image1.jpg)  

The system will display the Accounts Payable Open Installment screen.
...
![](../static/img/docs/SAF-4050/image3.jpg)  
...
![](../static/img/docs/SAF-4050/image5.jpg)  
...
![](../static/img/docs/SAF-4050/image7.jpg)  

8.  You can filter the list of installments in the screen to show only
...
9.  Clicking the Show All option will cause the system to list all
    ...
    option will also display the details of each installment, including
    ...
    the original installment with the value of any cancelled transactions
...
13. The transaction type that caused the installment is displayed in the
...
18. The system displays the date on which the installment is due to be
...
24. The system displays the original amount of the installment in the
