...
![](../static/img/docs/SAF-502/image203.png) 
...
Use the procedure titled **[Customer Profile](https://sense-i.co/docs/1202)** to do this.  
:::  
...
![](../static/img/docs/SAF-502/image207.png)  
...
16. Enter the **Quantity of the item** that you are quoting to the customer in the **Trx Quantity** field. _(You can press the 
...
3. Once you have completed entering all the Sales Quotes you need to capture in the system, click the ![](../static/img/docs/button/but-close1.png) button 
...
The program will display a form that will allow you to enter certain key information that is required for a copy, for example the **Due Date**.
