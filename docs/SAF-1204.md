...
7.  If the Employee is a **Customer Representative** and handles **Sales Quotes and Sales Orders** for the company, then check the **Representative** field.  
    ...
    S*imilarly, if the employee represents your company when dealing with **Suppliers** and handles *Purchase Orders**, then check the **Representative** field.  
...
15.  Select the Day of the Week or Day of the Month on which payment is
