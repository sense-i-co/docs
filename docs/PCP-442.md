...
5. If a **Name Format** has been defined for the Material Type the system will open a window titled **Define Item Name and Description**.  
...
-   A **Standard item** is an item that is bought from the supplier as is, without any modifications.  
...
6.  If the item is a standard material, select the **Standard** category.  
    If the item is a **variation** of a Standard material or a **Customised** material, you can select these options from the **Category drop down** list.  
...
9. You can optionally choose to include these Rich Text Descriptions in the **Purchase documents** you print and can also print these descriptions in the **Supplier Price List** and **Catalogue** if you choose.  

### Add Images to Material Information  

You can store one or more images against a material record. Again these can be used when printing Purchase Orders, Price Lists or instruction forms.  
...
:::tip  
It is a good idea to store all images on a separate shared drive on the network that has the same drive letter for each user.  
This enables every user in the company to access the same images, documents and technical details for each Material.  
:::  
...
6. You can add as many images as you wish to the Material Item you are adding to the Catalogue.  
...
Once you have entered the Item Profile in the Catalogue you will need to enter information about the **Supplier**, **Supplier Item Name/Code**, **Lead Time**, **Quality**, and **Purchase Prices** for the item you are adding to the system.  
...
You will notice a set of **tabs** on the **Add Material** screen. These tabs make it easier to group information in different screens so that you see only the information you need to at any time.  

### Add Sourcing and Cost Price Information  

1. Click on the **Price Information** tab to enter pricing information about the supplier item.  
	
![](../static/img/docs/SAF-442/image45.png)  

2. Click on the **three dot button** to select the name of the **Supplier** that sells the Item you are adding to the database.  
	
![](../static/img/docs/SAF-442/image27.png)  

3. Choose the name of the correct Supplier and then click the **Select** button.  
...
:::tip  
You can press the **[Tab]** key on your keyboard to quickly move from one field to the next.  
:::  
...
12. Then click the **Close** button and the system will return you to the Material Catalogue.  
...
6. You can add as many documents of as many different types as you wish to the Item you are adding to the Supplier Catalogue.  
...
The COST PRICE is the price that a company pays to **buy an item** from a Supplier or to **make an item** in one of its Departments.  

The SELLING PRICE is the price that a company **charges its Customers** for the item.  

![](../static/img/docs/MAS-009/image60.jpg)  

There are several scenarios for capturing PRICE INFORMATION in the SEMS system. And these scenarios are dependent on two aspects.  
...
This structure is then mirrored in the **Price Information** screen in the SEMS System.  
...
The **Cost Price** must then be captured in the **Supplier Price Information** section of the screen.  
