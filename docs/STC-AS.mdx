...
The Detailed grid shows the same data within the context of the Actual Stock view. 
Select a cell by clicking on it. You will see the corresponding quantity or cost column will be shaded.

To further validate these numbers, drill down to a list of the originating list of Source Transactions.
