...
:::important  
This would only occur under the following conditions:
...
In certain instances SEMS Users / Employees would not use email.  In these instances the issuing of OTP would be required.  
:::
...
Administrators would this procedure to issue a Manual OTP _(One-Time-Pin)_ when SEMS Users / Employees have forgotten their Login Password.  

This is neccessary in those instances where Company Outgoing Email configuration has NOT been setup, and/or SEMS Users / Employees do not use email, or do not have access to their email.  
...
The **One-Time-Pin** section now becomes available. 

5.  Enter a unique One-Time-Pin in the **Manual OTP** field.  

![](../static/img/docs/CNF-003/image21.png)  

:::important  
The Manual OTP can be any combination of characters, special characters and/or numbers.  

It is important to note that the **One-Time-Pin is Case Sensitive**.  
:::
...
![](../static/img/docs/CNF-003/image22.png)  

7.  Click the **OK** button to close the Information dialogue box.  
...
8.  The One-Time-Pin can now be communicated to the SEMS User / Employee.  

9. Click the **Close** button to exit the Login User screen(s).  
