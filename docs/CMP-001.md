...
:::tip  
If you leave the **Account Folder Name** blank, the system will automatically generate an appropriate Account Folder Name on **Activation** of the Company Profile.  
...
This folder is typically used to store relevant & important Company documents, such as Company Rgistration certificates, VAT Registration certifcates, Bank Account Confirmation letters etc.  
:::  
...
1.  Click on the **Contacts** TAB to view the Company Contacts grid list.  


![](../static/img/docs/CMP-001/image06.png)  

	
2.	To add a contact, click the **Add** button on the Action Bar.

3.  The system will display a screen titled **Add Contact**. Simply enter as much information as you need about the contact in the fields on this screen.  

![](../static/img/docs/CMP-001/image07.png)  

:::note
This screen enables you to enter all of the information you might need to maintain accurate and complete contact records.
:::

4.  When you have completed entering details for the contact, click the **Save** button, and then the **Close** button on the Action Bar.

5.  You can repeat the steps above for each contact you need to add.  
...
1.  To enter Bank Account details for the Company, click the **Bank Accounts** TAB.

    The Bank Accounts grid screen will be displayed.  
...
6.  Enter the **Bank Account Numer**.  
...
9.  Click the **Save** button, and then the **Close** button on the Action Bar.  

10. Repeat steps 2 - 9 above to capture any additional Bank Accounts for the Company.  
...
For detailed guidelines on configuring **Email Settings**, refer to the document titled **["Configure Email Information & Settings"](https://sense-i.co/docs/CNF001)**  
:::  
