...
:::important Procedure Document to be released  
The process of defining **Product Groups** and **Product Types** within the relevant Resourse Category _(Products)_, is detailed in the soon te be released, **Define Product Groups & Types** document.  
:::
